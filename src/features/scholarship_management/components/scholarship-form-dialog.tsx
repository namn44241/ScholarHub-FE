...
export const ScholarshipFormDialog = ({
  ...
  const dialogDescription =
    DIALOG_DESCRIPTIONS[formType] || "Fill in the details below.";
  ...
  useEffect(() => {
    ...
    const hasValues =
      currentWeights && Object.values(currentWeights).some((val) => val !== "");
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-[600px] md:max-w-[800px] max-h-[90vh] overflow-hidden">
        ...
        {isLoading ? (
          ...
          <Form {...form}>
            <form
              onSubmit={isReadOnly ? (e) => e.preventDefault() : onSubmit}
              className="space-y-4"
            >
                  ...
                  <ScrollArea className="pr-4 h-[60vh]">
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <FormDescription>
                          Drag and drop to reorder criteria by importance
                        </FormDescription>
